...
import defaultFossilsDescriptorsTemplate from 'templates/views/components/functions/bc-fossils-descriptors.htm';
export default ko.components.register(
    'views/components/functions/bc-fossils-descriptors',
    {
