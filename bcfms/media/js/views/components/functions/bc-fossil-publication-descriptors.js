...
import defaultFossilsDescriptorsTemplate from 'templates/views/components/functions/bc-fossil-publication-descriptors.htm';
export default ko.components.register(
    'views/components/functions/bc-fossil-publication-descriptors',
    {
