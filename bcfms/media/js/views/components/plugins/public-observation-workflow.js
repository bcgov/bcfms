...
import $ from 'jquery';
import arches1 from 'arches';
import Workflow from 'viewmodels/workflow';
import WorkflowStep from 'viewmodels/workflow-step';
import defaultWorkflowTemplate from 'templates/views/components/plugins/public-observation-workflow.htm';
export default ko.components.register('public-observation-workflow', {
                        ...
                        componentConfigs: [
                            {
                                ...
                                uniqueInstanceName:
                                    'observer-info' /* unique to step */,
                                tilesManaged: 'one',
                                parameters: {
                                    graphid:
                                        '82efcd14-82db-11ec-b8e6-5254008afee6',
                                    nodegroupid:
                                        'ac37b2f4-82db-11ec-96d0-5254008afee6',
                                },
                            },
                        ],
                    },
                        ...
                        componentConfigs: [
                            {
                                componentName: 'default-card',
                                uniqueInstanceName:
                                    'location-description' /* unique to step */,
                                tilesManaged: 'one',
                                parameters: {
                                    graphid:
                                        '82efcd14-82db-11ec-b8e6-5254008afee6',
                                    nodegroupid:
                                        '0d429c06-83d8-11ec-9043-5254008afee6',
                                    resourceid:
                                        "['set-observer-info']['observer-info'][0]['resourceInstanceId']",
                                },
                            },
                        ],
                    },
                        ...
                        componentConfigs: [
                            {
                                componentName: 'default-card',
                                uniqueInstanceName:
                                    'photographs' /* unique to step */,
                                tilesManaged: 'one',
                                parameters: {
                                    graphid:
                                        '82efcd14-82db-11ec-b8e6-5254008afee6',
                                    nodegroupid:
                                        'c26e4a9c-82db-11ec-b00b-5254008afee6',
                                    resourceid:
                                        "['set-observer-info']['observer-info'][0]['resourceInstanceId']",
                                },
                            },
                        ...
                        componentConfigs: [
                            {
                                componentName: 'default-card',
                                uniqueInstanceName:
                                    'location-map-file' /* unique to step */,
                                tilesManaged: 'one',
                                parameters: {
                                    graphid:
                                        '82efcd14-82db-11ec-b8e6-5254008afee6',
                                    nodegroupid:
                                        'a7a473b0-83be-11ec-a0d2-5254008afee6',
                                    resourceid:
                                        "['set-observer-info']['observer-info'][0]['resourceInstanceId']",
                                },
                            },
                        ...
                        componentConfigs: [
                            {
                                componentName: 'default-card',
                                uniqueInstanceName:
                                    'location-coordinates' /* unique to step */,
                                tilesManaged: 'one',
                                parameters: {
                                    graphid:
                                        '82efcd14-82db-11ec-b8e6-5254008afee6',
                                    nodegroupid:
                                        'cbe9284c-83be-11ec-805f-5254008afee6',
                                    resourceid:
                                        "['set-observer-info']['observer-info'][0]['resourceInstanceId']",
                                },
                            },
