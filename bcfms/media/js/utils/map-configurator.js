...
const mapConfigurator = {
    ...
    icons: [
        {
            name: 'micro-marker',
            url: '/bc-fossil-management/static/img/markers/micro.png',
        },
        {
            name: 'macro-marker',
            url: '/bc-fossil-management/static/img/markers/macro.png',
        },
        {
            name: 'macromicro-marker',
            url: '/bc-fossil-management/static/img/markers/macromicro.png',
        },
        {
            name: 'nosize-marker',
            url: '/bc-fossil-management/static/img/markers/nosize.png',
        },
    ],
