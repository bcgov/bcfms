...
class ActivityStreamCollectionTests(TestCase):
    ...
    def test_uncertain_formatting(self):
        self.assertEqual(
            ScientificTermsFormatter.format_uncertain("certain", False), "certain"
        )
        self.assertEqual(
            ScientificTermsFormatter.format_uncertain("uncertain", True), "uncertain ?"
        )
        self.assertEqual(
            ScientificTermsFormatter.format_uncertain("should be uncertain", True),
            "should be uncertain ?",
        )
    ...
    def test_format_times(self):
        for time_format in self.times_formats:
            self.assertEqual(
                ScientificTermsFormatter.format_times(
                    time_format["parts"]["min"],
