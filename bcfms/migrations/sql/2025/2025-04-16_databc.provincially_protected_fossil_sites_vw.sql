...
select n.resourceinstanceid                                                                            site_id,
       ...
       databc.html_to_plain_string(n.description -> 'en' ->> 'value')                                  site_description,
       __arches_get_concept_label(ps.protection_status)                                                protection_status,
       l.area_boundaries,
       databc.html_to_plain_string(pda.location_description -> 'en' ->> 'value')                       location_description,
       ...
       array_to_string(array_agg(__bc_format_uncertainty(__arches_get_concept_label(geological_group),
                                                         geological_group_uncertain)), '; ')           geologic_group,
       array_to_string(array_agg(__bc_format_uncertainty(__arches_get_concept_label(geological_formation),
                                                         geological_formation_uncertain)),
                       '; ')                                                                           geologic_formation,
       array_to_string(array_agg(__bc_format_uncertainty(__arches_get_concept_label(geological_member),
                                                         geological_member_uncertain)), '; ')          geologic_member
...
group by n.resourceinstanceid,
         n.site_name -> 'en' ->> 'value',
         n.description -> 'en' ->> 'value',
         __arches_get_concept_label(ps.protection_status),
         l.area_boundaries,
         pda.location_description -> 'en' ->> 'value',
         __arches_get_concept_label(ga.geologic_timescale_division),
         __bc_format_uncertainty(__arches_get_concept_label(ga.minimum_time), ga.minimum_time_uncertain),
         __bc_format_uncertainty(__arches_get_concept_label(ga.maximum_time), ga.maximum_time_uncertain);
